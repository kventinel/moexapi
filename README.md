...
Сейчас можно установить через клонирование репозитория с гита.

TODO: Установка через pip
...
```
In [5]: pymoex.Candles(pymoex.Ticker('GAZP'), start_date=datetime.date(2023, 10, 2), end_date=datetime.date(2023, 10, 2))
...
```
In [2]: pymoex.Bond(pymoex.Ticker('SU26238RMFS4'))
